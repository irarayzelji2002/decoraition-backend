      ...
      >
        <div className="center-me" style={{ margin: "24px" }}>
          ...
          <p style={{ maxWidth: "800px" }}>
            Welcome to DecorAItion, a web application that provides AI-powered
            design assistance for home, commercial, and outdoor projects. By
            using DecorAItion, you agree to these Terms and Conditions. If you
